...
namespace Atc.CodingRules.Updater.CLI
{
    public static class ConfigHelper
    {
        ...
        private static void DeleteSuppressionsFileInTempPath(DirectoryInfo temporarySuppressionsPath)
        {
            var temporarySuppressionsFile = Path.Join(temporarySuppressionsPath.FullName, AtcCodingRulesSuppressionsFileName);
