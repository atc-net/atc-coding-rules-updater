...
{
    public const string AreaEditorConfig = ":mouse_face:";
    public const string AreaDirectoryBuildProps = ":hammer:";
    ...
    public const string Skipped = ":back_arrow:";
    public const string DuplicateKey = ":key:";
