...
public static class EditorConfigHelper
{
        ...
        DirectoryInfo projectPath)
    {
        ...
        return Helpers.FileHelper.WriteAllTextAsync(rootEditorConfigFile, contentToWrite);
    }
        ...
        string contentGitBasePart)
    {
        ...
        logger.LogInformation($"{Console.Spectre.EmojisConstants.FileUpdated}   {descriptionPart} files merged");
